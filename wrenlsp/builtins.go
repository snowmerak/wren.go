...
var builtinSymbols = []ForeignMethodInfo{
	...
	// Async - Built-in async utilities
	{
		...
		Signature: "await(_)",
		IsStatic:  true,
		Doc:       "Waits for a future to complete and returns its result. Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
		...
		Signature: "isReady(_)",
		IsStatic:  true,
		Doc:       "Checks if a future is ready without blocking. Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
		...
		Signature: "get(_)",
		IsStatic:  true,
		Doc:       "Retrieves the result of a future if it's ready. Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
		...
		Signature: "cancel(_)",
		IsStatic:  true,
		Doc:       "Cancels a future. Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
		Method:    "getState",
		Signature: "getState(_)",
		IsStatic:  true,
		Doc:       "Returns the state of a future (0=Pending, 1=Completed, 2=Failed, 3=Cancelled). Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
		...
		Signature: "cleanup(_)",
		IsStatic:  true,
		Doc:       "Removes a completed future from memory. Parameter: futureId.",
	},
	{
		Module:    "async",
		Class:     "Async",
