...
const lspTemplate = `// Code generated by wrengen. DO NOT EDIT.
...
{{range $module := .}}	// {{$module.ModuleName}} module (auto-generated)
{{range $method := $module.Methods}}	{
		Module:    "{{$module.ModuleName}}",
		Class:     "{{$module.ClassName}}",
		Method:    "{{$method.WrenName}}",
		Signature: "{{$method.Signature}}",
		IsStatic:  {{$method.IsStatic}},
		Doc:       "{{$method.WrenName}} method from {{$module.ClassName}} class.",
	},
{{end}}{{end}}}
`